    <div class="container top">
      ...
      echo form_open('admin/facilities/update/'.$this->uri->segment(4).'', $attributes);
      ?>
        <fieldset>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" id="facility_name" name="facility_name" value="<?php echo $facility[0]['facility_name']; ?>" >
            ...
            <div class="hidden-slide-down">
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" id="street_number" name="facility_address1" value="<?php echo $facility[0]['facility_address1']; ?>" >
                        <!--<span class="help-inline">Woohoo!</span>-->
                    </div>
                </div>
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" id="route" name="facility_address2" value="<?php echo $facility[0]['facility_address2']; ?>" >
                        <!--<span class="help-inline">Woohoo!</span>-->
                    </div>
                </div>
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" id="locality" name="facility_locality" value="<?php echo $facility[0]['facility_locality']; ?>" >
                        <!--<span class="help-inline">Woohoo!</span>-->
                    </div>
                </div>
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" id="administrative_area_level_2" name="facility_county" value="<?php echo $facility[0]['facility_county']; ?>" >
                        <!--<span class="help-inline">Woohoo!</span>-->
                    </div>
                </div>
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" id="country" name="facility_country" value="<?php echo $facility[0]['facility_country']; ?>" >
                        <!--<span class="help-inline">Woohoo!</span>-->
                    </div>
                </div>
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" id="postal_code_prefix" name="facility_postcode" value="<?php echo $facility[0]['facility_postcode']; ?>" >
                        <!--<span class="help-inline">Woohoo!</span>-->
                    </div>
                </div>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" id="facility_max_capacity" name="facility_max_capacity" value="<?php echo $facility[0]['facility_max_capacity']; ?>" >
                    <!--<span class="help-inline">Woohoo!</span>-->
                </div>
            </div>
