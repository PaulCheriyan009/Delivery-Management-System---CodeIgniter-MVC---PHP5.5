<div class="container top">
    ...
    echo form_open('admin/suppliers/add', $attributes);
    ?>
    <fieldset>
        ...
        <div class="hidden-slide-down">
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" id="street_number" name="company_address1" value="<?php echo set_value('facility_address1'); ?>" >
                </div>
            </div>
            <div class="control-group">
                <label for="inputError" class="control-label">Address 2</label>
                <div class="controls">
                    <input type="text" id="route" name="company_address2" value="<?php echo set_value('facility_address2'); ?>" >
                </div>
            </div>
            <div class="control-group">
                <label for="inputError" class="control-label">Town / City</label>
                <div class="controls">
                    <input type="text" id="locality" name="company_locality" value="<?php echo set_value('facility_locality'); ?>" >
                </div>
            </div>
            <div class="control-group">
                <label for="inputError" class="control-label">County</label>
                <div class="controls">
                    <input type="text" id="administrative_area_level_2" name="company_county" value="<?php echo set_value('facility_country'); ?>" >
                </div>
            </div>
            <div class="control-group">
                <label for="inputError" class="control-label">Country</label>
                <div class="controls">
                    <input type="text" id="country" name="company_country" value="<?php echo set_value('facility_country'); ?>" >
                </div>
            </div>
            <div class="control-group">
                <label for="inputError" class="control-label">Postcode</label>
                <div class="controls">
                    <input type="text" id="postal_code_prefix" name="company_postcode" value="<?php echo set_value('facility_postcode'); ?>" >
                </div>
            </div>
        </div>
        <div class="control-group">
            ...
            <div class="controls">
                <input type="text" id="company_sector" name="company_sector" placeholder="Please enter what the company does" value="<?php echo set_value('company_sector'); ?>" >
            </div>
        </div>
